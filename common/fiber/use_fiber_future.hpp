...
#ifndef BOOST_ASIO_USE_FIBERS_FUTURE_HPP
#define BOOST_ASIO_USE_FIBERS_FUTURE_HPP
 ...
 * boost::asio::fibers::use_future. For example:
 *
 * @code boost::fibers::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, boost::asio::fibers::use_future); @endcode
 *
...
public:
  ...
  /// @c boost::fibers::promise object for a given asynchronous operation.
   ...
   * operation, the result of the function object is retuned via a boost::fibers::future.
   *
   * @par Example
   *
...
#endif // BOOST_ASIO_USE_FIBERS_FUTURE_HPP

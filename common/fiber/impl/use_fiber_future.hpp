...
public:
  ...
  promise_handler(boost::asio::fibers::use_future_t<Allocator> u)
...
inline boost::asio::fibers::detail::packaged_token<typename decay<Function>::type, Allocator>
boost::asio::fibers::use_future_t<Allocator>::operator()(BOOST_ASIO_MOVE_ARG(Function) f) const
{
  return boost::asio::fibers::detail::packaged_token<typename decay<Function>::type, Allocator>(
...
class async_result<boost::asio::fibers::use_future_t<Allocator>, Result(Args...)>
  : public boost::asio::fibers::detail::promise_async_result<
      void(typename decay<Args>::type...), Allocator>
{
public:
  explicit async_result(
    typename boost::asio::fibers::detail::promise_async_result<void(typename decay<Args>::type...),
      Allocator>::completion_handler_type& h)
    : boost::asio::fibers::detail::promise_async_result<
...
class async_result<boost::asio::fibers::detail::packaged_token<Function, Allocator>, Result(Args...)>
  : public boost::asio::fibers::detail::packaged_async_result<Function, Allocator,
      typename result_of<Function(Args...)>::type>
{
public:
  explicit async_result(
    typename boost::asio::fibers::detail::packaged_async_result<Function, Allocator,
      typename result_of<Function(Args...)>::type>::completion_handler_type& h)
    : boost::asio::fibers::detail::packaged_async_result<Function, Allocator,
...
class async_result<boost::asio::fibers::use_future_t<Allocator>, Result()>
  : public boost::asio::fibers::detail::promise_async_result<void(), Allocator>
{
public:
  explicit async_result(
    typename boost::asio::fibers::detail::promise_async_result<
      void(), Allocator>::completion_handler_type& h)
    : boost::asio::fibers::detail::promise_async_result<void(), Allocator>(h)
  {
  }
};

template <typename Function, typename Allocator, typename Result>
class async_result<boost::asio::fibers::detail::packaged_token<Function, Allocator>, Result()>
  : public boost::asio::fibers::detail::packaged_async_result<Function, Allocator,
...
#define BOOST_ASIO_PRIVATE_ASYNC_RESULT_DEF(n) \
  ...
  class async_result<boost::asio::fibers::use_future_t<Allocator>, \
  ...
  template <typename Function, typename Allocator, \
      typename Result, BOOST_ASIO_VARIADIC_TPARAMS(n)> \
  class async_result<boost::asio::fibers::detail::packaged_token<Function, Allocator>, \
      Result(BOOST_ASIO_VARIADIC_TARGS(n))> \
    : public boost::asio::fibers::detail::packaged_async_result<Function, Allocator, \
